...
public class CheckGM extends Command {
        ...
        if (sender instanceof Player) {
            ...
            if (SubRank.subranks.get(u.getArtRank()).getPermissions() > 0 ||
                ...
                for (Integer i : highRequests) {
                    ...
                    if (r.getType().equals(Request.RequestType.GM)) {
                        ...
                        if (r.getStage().equals(Request.RequestStage.UNCLAIMED)) {
                            ...
                            if (r.isGroup()) {
                                ...
                                b.append("&7").append(r.getId()).append(" ").append("&3[&b&lGROUP&3] &bGM &c[✫✫✫&c] &7");

                            } else {

                                b.append("&7").append(r.getId()).append(" ").append("&2[&a&lOPEN&2] &bGM &c[✫✫✫&c] &7");
                            ...
                            if (r.isGroup()) {
                                ...
                                b.append("&7").append(r.getId()).append(" ").append("&6[&e").append(User.getUser(r.getClaim().get(0)).getName()).append("&6] &bGM &c[✫✫✫&c] &7");
                    ...
                    if (r.getType().equals(Request.RequestType.GM)) {
                        ...
                        if (r.getStage().equals(Request.RequestStage.UNCLAIMED)) {
                            ...
                            if (r.isGroup()) {
                                ...
                                b.append("&7").append(r.getId()).append(" ").append("&3[&b&lGROUP&3] &bGM &e[✫✫&7✫&e] &7");

                            } else {

                                b.append("&7").append(r.getId()).append(" ").append("&2[&a&lOPEN&2] &bGM &e[✫✫&7✫&e] &7");
                            ...
                            if (r.isGroup()) {
                                ...
                                b.append("&7").append(r.getId()).append(" ").append("&6[&e").append(User.getUser(r.getClaim().get(0)).getName()).append("&6] &bGM &e[✫✫&7✫&e] &7");
                    ...
                    if (r.getType().equals(Request.RequestType.GM)) {
                        ...
                        if (r.getStage().equals(Request.RequestStage.UNCLAIMED)) {
                            ...
                            if (r.isGroup()) {
                                ...
                                b.append("&7").append(r.getId()).append(" ").append("&3[&b&lGROUP&3] &bGM &a[✫&7✫✫&a] &7");

                            } else {

                                b.append("&7").append(r.getId()).append(" ").append("&2[&a&lOPEN&2] &bGM &a[✫&7✫✫&a] &7");
                            ...
                            if (r.isGroup()) {
                                ...
                                b.append("&7").append(r.getId()).append(" ").append("&6[&e").append(User.getUser(r.getClaim().get(0)).getName()).append("&6] &bGM &a[✫&7✫✫&a] &7");
