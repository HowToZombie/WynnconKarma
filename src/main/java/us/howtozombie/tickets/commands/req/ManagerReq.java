...
public class ManagerReq extends Command {
        ...
        if (sender instanceof Player) {
            ...
            if (SubRank.subranks.get(u.getArtRank()).getPermissions() > 0 ||
                ...
                if (args.length < 2) {
                    ...
                    sendMessage(sender, "&c⚠ &4Invalid Syntax! &c/managerreq [urgency] [request]");
                    return true;
                ...
                Request.createNewRequest(Main.requests, "MANAGER", b.toString(), urgency, u, ((Player) sender).getLocation());
