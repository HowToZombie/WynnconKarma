...
public class DevTag extends Command {
    ...
    public boolean execute(CommandSender sender, String s, String[] args) {
        ...
        if (sender.hasPermission("karma.tag.dev") || sender instanceof ConsoleCommandSender) {
            if (args.length < 1) {
                sendMessage(sender, "&c⚠ &4Invalid Syntax! &c/devtag [player] [tag]");
                return true;
