...
public class CMDTag extends Command {
    ...
    public boolean execute(CommandSender sender, String s, String[] args) {
        ...
        if (sender.hasPermission("karma.tag.cmd") || sender instanceof ConsoleCommandSender) {
            if (args.length < 1) {
                sendMessage(sender, "&c⚠ &4Invalid Syntax! &c/cmdtag [player] [tag]");
                return true;
