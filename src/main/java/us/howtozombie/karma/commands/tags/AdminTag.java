...
public class AdminTag extends Command {
    ...
    public boolean execute(CommandSender sender, String s, String[] args) {
        ...
        if (sender.hasPermission("karma.tag.admin") || sender instanceof ConsoleCommandSender) {
            if (args.length < 1) {
                sendMessage(sender, "&c⚠ &4Invalid Syntax! &c/admintag [player] [tag]");
                return true;
